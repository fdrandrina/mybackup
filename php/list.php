...
<script 
    type= "module"
    src="<?php echo base_url()?>assets/js/myvideo/myvideo_trainee.js">
</script>
            ...
            <div class="row" id="arrow">
                        ...
                        <div class="col-sm-9">
                            <div>
                                <div>
                                    ...
                                    <div id="myctr" hidden>
                                        <div class="myctr-btn col-sm-12">
                                            ...
                                            <button class="row" id="save-control" hidden>
                                    ...
                                    <div class="col-sm-12 row" id="traitement">
                                            <!-- <div>
                                                <p class="legende">Durée transcription OpenAI:  </p>
                                            </div> -->
                                            <!-- <div class="row ">
                                                <p class="video-date"><?php echo $value->time_rec ; ?></p>
                                            </div> -->
                                            <!-- <div class="row ">
                                                <p class="video-date">ms</p>
                                            </div> -->
                                    </div>
                                    <?php } ?>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div  class="line-bold col-sm-12"></div>
                                    <div class="col-sm-12 " id="basic-stats">
                                        <div class="row">
                                        ...
                                        <div class="spaced row">
                                            ...
                                            <div class="stats" id="id-words">00</div>
                                        </div>
                                        <div class="row spaced">
                                        <p class="spaced"> hapaxes: </p>
                                        <div class="stats" id="id-hapax">00</div>
                                        </div>
                                        <div class="spaced row">
                                ...
                                <div hidden>
                                    <div id="glossaire">
                                        ...
                                        <div id = "conjugaison-container" class="row"></div>  
                                        <center>
                                            <h1>Phrase</h1>
                                        </center> 
                                        <div id = "sent-container" class="row"></div>
                                        <div id = "concord-container" class="row"></div>  
                                    </div> 
                                </div>
                                <p class="legende obst" >Observation</p>
                                <div class="col-sm-12">
                                    <div class="search">
                                        <textarea type="text" class="" placeholder="Observation..." id="obscontent">
                                            <?php echo $value->file_obs ?? null; ?>
                                        </textarea>
                                        <div class="editButton" hidden></div>
                                ...
                                <div class="col mr-4 expression-container video-layout">
                                    ...
                                    <button class="play-list-btn" 
                                        ...
                                        `<?php 
                                            ...
                                            ?>`,
                                        `<?php 
                                            echo $value->id_expression;
                                            ?>`
                                        )"
                                    >
                                        <img src="assets/btn-play-list@2x.png" width="24px" height="24px">
                                    </button>
                                    <div class="row mt-2 mb-2 videoSubTitle">
                                        <div id="list_legend">
                                            <?php
                                                $legendtext = str_replace("\n", " ", $value->legende_f);
                                                echo $legendtext;
                ...
                <div hidden>
                    ...
                    <div class="col-sm-12 ml-4">
                        <div>
                            <i class="fa fa-file-audio-o col-sm-12">
                                Audio original bande: 
                            </i>
                        </div>
                        <div class="col-sm-12 tool-layout" id="audio-player"> 
                            <audio controls>
                                <source 
                                    src="<?php echo base_url().'groupes/GRP'.$groupeid.'/'.$value->audio_langue_origine; ?>" 
                                    type="audio/wav"
                                >
                        ...
                        <!-- Audio -->
                        <div>
                            <i class="fa fa-file-audio-o col-sm-12"></i>
                            Other versions:
                        </div>
                        <div class="col-sm-12 tool-layout" id="audio-recorded"></div>
                    ...
                    <div class="row" id="but-audio">
                        <button class="tool-layout" id="start-recording">
                            <i class="fa fa-microphone col-sm-12"></i>
                            Start
                        </button>
                        <button class="tool-layout" id="stop-recording" disabled>
                            <i class="fa fa-stop-circle"></i>
                            Stop
                        </button>
                        <button id="save-recording" class="tool-layout" disabled>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="typestats">List</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div id="stat-cont"></div>
      </div>
    </div>
  </div>
</div>
